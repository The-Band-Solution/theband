...
- [ ] T003 O CI builda a imagem quando ela muda
  - **Pronta quando**: T002
...
- [ ] T004 [US1] O workflow de CD conforme o contrato
  - **Pronta quando**: T003
...
- [ ] T005 [US1] O runbook do Dokploy no Contabo
  - **Pronta quando**: T004
...
- [ ] T006 [US2] O ensaio de restauração, escrito para ser executado
  - **Pronta quando**: T005

...
- [ ] **T001** Ler a lista de prefixos declarada — [#890](https://github.com/The-Band-Solution/theband/issues/890)
...
- [ ] **T002** [US1] Trazer os rótulos do campo para a listagem — [#891](https://github.com/The-Band-Solution/theband/issues/891)
...
- [ ] **T003** [P] [US1] Provar que a listagem não cresce em consultas — [#892](https://github.com/The-Band-Solution/theband/issues/892)
...
- [ ] **T004** [US3] Impedir que o rótulo vire conceito — [#893](https://github.com/The-Band-Solution/theband/issues/893)
...
- [ ] **T005** [US1] Mostrar os rótulos na tela, com a origem — [#894](https://github.com/The-Band-Solution/theband/issues/894)
...
- [ ] **T006** [US1] Derivar o rótulo do prefixo do título — [#895](https://github.com/The-Band-Solution/theband/issues/895)
...
- [ ] **T007** [US1] Mostrar as duas origens sem juntá-las — [#896](https://github.com/The-Band-Solution/theband/issues/896)
...
- [ ] **T008** [P] [US3] Recusar interpretar o conteúdo do rótulo — [#897](https://github.com/The-Band-Solution/theband/issues/897)
...
- [ ] **T009** Trazer o nome do repositório para a listagem — [#898](https://github.com/The-Band-Solution/theband/issues/898)
  - **Pronta quando**: nada além do repositório
  - **Descrição**: `list_issues` devolve hoje `observed_repository_id`, que é identificador interno. Trazer o **nome qualificado** por `collected_issues → observed_repositories → cmpo_source_repositories`. Duas junções, e **a terceira não é necessária**: o nome qualificado já traz a organização — `leds-conectafapes/conectafapes-project`. Um campo, não dois. **Nenhuma mudança de armazenamento**: a identidade já é única, e o defeito é de leitura — 5 033 issues em 2 699 números distintos. FR-016, FR-017, research R1
  - **Feita quando**: cada item traz o nome do repositório; o número de consultas da listagem continua o mesmo
  - **Teste**: `test/the_band/work_items/identidade_visivel_test.exs` — duas issues de repositórios diferentes **com o mesmo número** devolvem nomes diferentes; e o teste de custo da T003 continua verde

- [ ] **T010** Identificar o item na tela sem ambiguidade — [#899](https://github.com/The-Band-Solution/theband/issues/899)
  - **Pronta quando**: T009 concluída; o protótipo é a referência
  - **Descrição**: a listagem mostra o nome do repositório junto ao número. O nome é longo e precisa de truncamento **com o valor inteiro no `title`** — truncar sem isso troca uma ambiguidade por outra. FR-016, FR-017, SC-009
  - **Feita quando**: quem olha duas linhas com o mesmo número diz de quais repositórios são, sem abrir nenhuma
  - **Teste**: teste de tela — com duas issues de mesmo número, o HTML contém os **dois** nomes de repositório, e o `title` traz o nome completo
...
- [ ] **T011** [US2] Trazer os rótulos para as divergências — [#900](https://github.com/The-Band-Solution/theband/issues/900)
...
- [ ] **T012** [US2] Mostrar os dois lados e dizer qual venceu — [#901](https://github.com/The-Band-Solution/theband/issues/901)
...
- [ ] **T013** Conferir a tela contra o protótipo aprovado — [#902](https://github.com/The-Band-Solution/theband/issues/902)

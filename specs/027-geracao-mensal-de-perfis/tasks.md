...
- [x] T003 Fila própria para as rodadas
  - **Pronta quando**: nada além do repositório
...
- [x] T004 [P] Limiares de regeneração na base de conhecimento
...
- [x] T005 Validação recusa limiar ausente ou inválido
...
- [x] T006 [P] Migração dos eventos de automação
...
- [x] T008 [P] Migração das entradas de rodada
...
- [x] T009 [P] Schemas das três tabelas
...
- [x] T010 [US1] Ler os limiares sem padrão embutido
...
- [x] T011 [US1] Decidir quem entra na rodada, e por qual motivo não
...
- [x] T012 [US1] Ligar e desligar com autor
...
- [x] T013 [US1] Abrir, registrar e encerrar a rodada
...
- [x] T014 [US1] A geração devolve o consumo
...
- [x] T014a [US1] O material continua sendo o histórico inteiro
...
- [x] T015 [US1] A rodada executa sequencialmente, com checkpoint
...
- [x] T016 [US1] Falha de credencial encerra a rodada
...
- [x] T016a [US1] Quem falhou volta na rodada seguinte
...
- [x] T017 [US1] O cron mensal enfileira uma rodada por organização
...
- [x] T017a [US1] Subir a versão não gera nada
...
- [x] T018 [US2] Tela da geração automática
...
- [x] T019 [US2] Os nove números de cada rodada
...
- [x] T020 [US2] Ligar dispara a primeira rodada
...
- [x] T020a [US2] Pedir uma rodada a mão
...
- [x] T021 [US2] Uma organização não vê a rodada da outra

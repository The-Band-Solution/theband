...
- [x] T002 O cadastro transacional com temporária, pela violação
...
- [x] T003 A leitura estreita do conflito
...
- [x] T004 [US1] O cadastro na tela, com a temporária de uma vez
  - **Pronta quando**: T002 concluída
...
- [x] T005 [US2] A lista diz quem tem GitHub, numa consulta
...
- [x] T006 [US2] Associar com busca, e o conflito nomeado
...
- [x] T007 [US2] Revogar na área, e o login acompanha
...
- [x] T008 Gates verdes e PR no padrão

...
- [ ] **T001** Declarar os padrões de segredo em um lugar só
...
- [ ] **T002** Criar a tarefa de varredura
...
- [ ] **T003** Embutir o controle positivo na varredura
...
- [ ] **T004** [P] Recusar imprimir o valor encontrado
  - **Pronta quando**: T002 concluída
...
- [ ] **T005** Varrer o banco de desenvolvimento e registrar
...
- [ ] **T006** Fechar o segredo no caminho do provedor de modelos
...
- [ ] **T007** [P] Preencher as datas de encerramento ausentes
...
- [ ] **T008** Verificar registro terminado sem data
...
- [ ] **T009** Criar a tabela de sessões
...
- [ ] **T010** [P] Acrescentar a época de senha
...
- [ ] **T011** Abrir, conferir e encerrar sessão
...
- [ ] **T012** Migrar as sessões vivas sem derrubar ninguém
...
- [ ] **T013** Ler a sessão pela nova tabela
...
- [ ] **T015** Documentar o efeito de uma restauração sobre as sessões
...
- [ ] **T016** [P] Escrever o procedimento de girar todas as sessões
  - **Pronta quando**: T011 concluída

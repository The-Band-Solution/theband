...
- [x] **T001 [P]** Escrever os contratos antes da primeira função pública
...
- [x] **T002** Declarar as duas concessões na base — `data-model.md` §3.1
...
- [x] **T003 [P]** Emendar a regra da evidência para a v3 — `data-model.md` §3.2
...
- [x] **T004** A tabela e o schema da concessão de gestão
...
- [x] **T005** `EO.StructureGrants` — declarar, revogar, listar e alcançar
...
- [x] **T006** `pode_gerir_estrutura/3` substitui `pode_declarar_estrutura/4`
...
- [x] **T007** `/roles` concede e revoga *manages team structure*
...
- [x] **T008** A saída declarada e a data da declaração no esquema — `data-model.md` §1
...
- [x] **T009 [P]** As consultas do roster — `data-model.md` §4.1–4.2
...
- [x] **T010 [US1]** As duas abas de `/teams/:id`, com a aba na URL
...
- [x] **T011 [US1]** A seção *Members* por vínculo, a legenda, a discordância e *Where this team sits*
...
- [x] **T012 [US1]** Quem não gere lê tudo e não vê ação — e o evento é recusado com motivo
...
- [x] **T013 [US1]** O teto de consultas das duas abas, medido
...
- [x] **T014 [US3]** A saída grava quem e quando, alcança os dois papéis, e a coleta não recria
...
- [x] **T015 [US3]** "Left the team…" na linha, com data obrigatória e a origem do fim dita
...
- [x] **T016 [US4]** O equívoco alcança todos os vigentes do par
...
- [x] **T017 [US4]** "Mistake…" na linha, com razão obrigatória e o texto que separa de "saiu"
...
- [x] **T018 [US2]** `declare_role/6` e `change_role/5`
...
- [x] **T019 [US2]** "Declare role" / "Change role" na linha, e "＋ new role…" sem sair dela
...
- [x] **T020 [US2]** O lote "Declare all roles", por vínculo, na Estrutura
...
- [x] **T021 [P] [US5]** `role_holder_counts/3` — quantas pessoas por papel, aqui e na organização
  - Uma consulta com `count(distinct person_id)` total e filtrado. FR-029.
  - **Teste**: `roster_test.exs` — `describe "contagem por papel"`.

- [x] **T022 [US5]** A seção *Roles*: catálogo e criados, criar com código sugerido, renomear, ocultar
...
- [x] **T026 [US9]** A granulação e a janela vivem no endereço, com padrão por granulação
...
- [x] **T027 [US9]** *Prometido × Entregue*, com a definição junto do título
...
- [x] **T028 [US9]** Os três gráficos na equipe COMPOSTA, sobre o conjunto da equipe inteira
...
- [x] **T023** A escrita de projeto vive na Estrutura, sob o mesmo veredito
...
- [x] **T024 [P]** Isolamento entre tenants nas consultas novas
...
- [x] **T025** Gates, quickstart e documentos

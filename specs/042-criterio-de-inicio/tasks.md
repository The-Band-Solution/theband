...
A `FR-007` opera sobre `spo_project_boards.linked_at`, criada na feature 041 — **[PR #458](https://github.com/The-Band-Solution/theband/pull/458), não mergeado**. Nenhuma tarefa da Fase 2 em diante começa antes daquele merge.
...
- [ ] T001 Declarar o critério na rede
...
- [ ] T002 Declarar as relações do critério
...
- [ ] T003 Regenerar a documentação derivada
...
- [ ] T004 Criar a tabela do critério
  - **Pronta quando**: T002 concluída; PR #458 mergeado
...
- [ ] T005 Impedir alvo duplo e critério vigente duplicado
...
- [ ] T008 [US1] Delegar na fachada SPO
...
- [ ] T009 [US1] Resolver o início em lote
...
- [ ] T010 [US1] Nomear as três ausências
...
- [ ] T011 [US1] Listar os tipos de evento com volume
  - **Pronta quando**: T007 concluída
...
- [ ] T012 [US1] Declarar o critério na tela do projeto
...
- [ ] T013 [US1] Contar as atividades sem instante
...
- [ ] T014 [US2] Aplicar a escala de precedência
  - **Pronta quando**: T009 concluída
...
- [ ] T015 [US2] Declarar o critério na tela do quadro
...
- [ ] T016 [US2] Avisar quais quadros vão ignorar a declaração
...
- [ ] T017 [US3] Desempatar pela data do vínculo
...
- [ ] T018 [US3] Nomear o empate em vez de escolher
...
- [ ] T019 [US3] Listar as pendências de desambiguação
...
- [ ] T020 A proveniência acompanha o número
  - **Pronta quando**: T014 concluída
...
- [ ] T022 Explicar o desempate no ponto da decisão
...
- [ ] T024 Percorrer o quickstart a mão
...
|---|---|
| T001 e T004 | YAML e migração são arquivos diferentes, se o PR #458 já estiver mergeado |

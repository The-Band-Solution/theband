...
Medido: 36 dos 135 repositórios têm issues. **73% das linhas não têm trabalho a mostrar**, e
descobrir isso hoje exige ler 135 números.
...
Nove gates. O contrato da API vem antes da primeira função pública, em
...
├── spec.md          13 FR, 9 SC, 2 user stories, 5 casos de borda
├── research.md      R1 a R5

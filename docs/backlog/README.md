...
|---|---|---|
| [O relatório da pessoa e da equipe](relatorio-da-pessoa-e-da-equipe.md) | pedido de 2026-09-25: gerar, em **HTML ou PDF**, o retrato do que a tela da pessoa e a da equipe mostram. **É dado de pessoa num arquivo que sai da plataforma**, a mesma superfície do MCP: o veredito da tela vale na geração (inclusive o do perfil, H2-R), nada que a tela esconde entra, a geração fica registrada, e o texto de terceiro sai como texto. Cinco decisões antes da spec, a primeira sendo **HTML primeiro**, porque o PDF costuma arrastar dependência pesada | **a decidir** — exige avaliação do `security` antes do plano e protótipo antes do código |

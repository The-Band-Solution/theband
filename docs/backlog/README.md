...
| [Um servidor MCP para os dados](servidor-mcp.md) | expor as respostas da plataforma a agentes de terceiros, com a proveniência junto | **bloqueada** — depende de decidir autenticação e tenant, que é o que a [API pública](api-publica.md) decide |

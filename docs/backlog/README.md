...
| [O teste do fluxo reprova de vez em quando](teste-instavel-do-fluxo.md) | `fluxo_na_tela_test.exs:205` devolveu `{:error, :invalid}` ao montar a LiveView. **Mesma semente, resultados diferentes**: 2314 passaram, depois 2313 de 2314, depois 2314 de novo com a semente que reprovou. Gate que reprova por acaso treina quem lê a reexecutar até passar — e a próxima reprovação real vira mais uma instabilidade | média — achado em 2026-09-22 nos gates de outra feature |

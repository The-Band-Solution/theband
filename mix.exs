defmodule TheBand.MixProject do
  ...
  def project do
    [
      ...
      #
      # A proteção nunca foi aquela linha — é `test/the_band/decimal_limitado_test.exs`, que
      # reprova se a faixa do `Decimal` deixar de ser a corrigida. Ela continua de pé, e é
      # por isso que remover a exceção não reabre nada. A avaliação está em
